...
dir <- setwd("/Users/julian/Documents/github/juliandefreitas/self/limited_self_reference/e2_perception_youngOld/data")
...
p1.114<-p1.14+scale_fill_discrete(name = "", labels = c ("Young\nYou", "Old\nYou", "Stranger\nJohn")) +
  ...
  geom_signif(data=d.two,
              aes(xmin=1, xmax=2, annotations=star_mat[3], y_position=2.5),
...
annotate_figure(figure,top = text_grob("Experiment 7: 2ast and Future Selves", face = "bold", size = 27),
