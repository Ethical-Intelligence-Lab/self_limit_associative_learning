...
#		$ python postHitSandbox.py ../experiments/jdf/e9_singleIdentity_perception_youngOld/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/e9_singleIdentity_perception_youngOld/turkHitParams.py
...
projectNameForRequesters = "jdf-singleIdentity-e9-perception-youngOld"
...
pay = 2.00	
numAssignmentsToPost = 40 # turk calls this "Number of assignments per HIT"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/e9_singleIdentity_perception_youngOld/landingPage.html"
frameHeight = 675
