...
dir <- setwd("/Users/julian/Documents/github/juliandefreitas/self/limited_self_reference/e4_perception_youngOld_powered/data")
...
annotate_figure(figure,top = text_grob("Experiment 4: High-Powered Past and Future Selves", face = "bold", size = 27),
